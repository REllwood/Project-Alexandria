...
3. **Synthesize** — write the answer in the relevant note (`Concepts/`, `Entities/`, or a new `Sources/<slug>.md` tagged `#researched`), with inline citations to the URLs used.
